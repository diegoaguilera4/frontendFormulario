    ...
    async enviarControl() {
      try {
        ...
        if (this.selectedArea === "Otra") {
          this.selectedArea = this.selectedAreaOtra;
        }
        if (this.selectedDefectoLamina === "Otros") {
          this.selectedDefectoLamina = this.selectedDefectoLaminaOtros;
        }
        if (this.selectedDefectoCaja === "Otros") {
          this.selectedDefectoCaja = this.selectedDefectoCajaOtros;
        }
        ...
        let res = await axios.post("http://localhost:3000/api/agregar", {
          ...
          causaLamina: this.selectedCausaLamina,
          defectoEnCaja: this.selectedDefectoCaja,
          causaCaja: this.selectedCausaCaja,
          operadorPicadora: "X",
          cliente: "X",
          producto: "X",
          cantidad: 1,
